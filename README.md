...
![banner de coders](cder.png)
Hello, my name is Vhagner Tapullima Herrera
========================
<img align="right" alt="Coding" width="200" src="https://media4.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif"><br>
- 👨‍💻 I’m currently working on machine learning and data mining projects using python.<br> 
...
<!--
**vhagner-herrera/vhagner-herrera** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
